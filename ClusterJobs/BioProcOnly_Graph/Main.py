...
def main():
    ...
    graph = AllGoGraph(f'./Yeast Resources/Pairwise/Spell/BioProcessOnly/BioProcessOnly_113x{sys.argv[2]}x53_Net_fold',f'113x{sys.argv[2]}x53','BioProcOnly',inputVector='x',ontologyDataset='original')
