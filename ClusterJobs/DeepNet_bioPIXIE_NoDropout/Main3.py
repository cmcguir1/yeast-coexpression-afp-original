...
def main():
    ...
    GOTest = AllGoModel(int(sys.argv[1]),'25000x5000x5000x5000x5000x5000x5000x5000x5000','DeepNet_bioPIXIE_Dropout0.5',f'Overfit',foldFile='./src/PairwiseYeastNetwork/AllGOGeneFold1.csv',ontologyDataset='original',resetNet=False,hiddenDropout=0.5,inputVector='xlpg',cuda=False)
