...
def main():
    ...
    graph = YeastGraph(f'Yeast Resources/Pairwise/{folderName}/{term[0:2]}{term[3:]}_{sys.argv[2]}x1_Net_fold',f'113x{sys.argv[2]}x1',term,f'SingleTerms_{sys.argv[2]}')
    graph.feedForward(save=False,calcAll=True,calcAgn=False,calcPos=True)
