...
def main():
    ...
    GOTest = AllGoModel(int(sys.argv[1]),'50000x10000x5000x5000','OverFit_bioPIXIE_Dropout0.5',f'Overfit',foldFile='./src/PairwiseYeastNetwork/AllGOGeneFold1.csv',ontologyDataset='original',resetNet=True,hiddenDropout=0.5,inputVector='xlpg',cuda=False)
