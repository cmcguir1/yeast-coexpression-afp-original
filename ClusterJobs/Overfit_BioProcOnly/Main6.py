...
def main():
    ...
    GOTest = AllGoModel(int(sys.argv[1]),'50000x10000x5000','Overfit_BioProcOnly',f'Overfit',foldFile='./src/PairwiseYeastNetwork/AllGOGeneFold1.csv',ontologyDataset='original',resetNet=True,cuda=False,includeLocalization=True)
