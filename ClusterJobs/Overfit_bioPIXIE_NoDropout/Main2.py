...
def main():
    ...
    GOTest = AllGoModel(int(sys.argv[1]),'50000x10000x5000x5000','OverFit_bioPIXIE',f'Overfit',foldFile='./src/PairwiseYeastNetwork/AllGOGeneFold1.csv',ontologyDataset='original',resetNet=True,inputVector='xlpg',cuda=False)
