...
def main():
    ...
    GOTest = AllGoModel(int(sys.argv[1]),sys.argv[2],'bioPIXIE_Data',f'Original',foldFile='./src/PairwiseYeastNetwork/AllGOGeneFold1.csv',ontologyDataset='original',inputVector='xlpg',resetNet=True)
