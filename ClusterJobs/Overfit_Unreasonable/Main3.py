...
def main():
    ...
    GOTest = AllGoModel(int(sys.argv[1]),'100000x10000x5000','OverFit_Unreasonable',f'Overfit',foldFile='./src/PairwiseYeastNetwork/AllGOGeneFold1.csv',ontologyDataset='original',resetNet=True,inputVector='xlpg',cuda=False)
    GOTest.trainNetwork(500000,track=100)
    GOTest.testNetworkAll(runAll=True)
    GOTest.testNetworkAll(runAll=True,validation=False)
