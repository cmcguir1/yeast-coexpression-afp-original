...
def main():
    ...
    GOTest = AllGoModel(int(sys.argv[1]),'25000','LearningRate',f'LearningRate_{sys.argv[2]}',foldFile='./src/PairwiseYeastNetwork/AllGOGeneFold1.csv',ontologyDataset='original',lr=float(sys.argv[2]),resetNet=True)
