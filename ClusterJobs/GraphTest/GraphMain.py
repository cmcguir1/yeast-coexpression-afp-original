...
def main():
    ...
    graph = AllGoGraph(f'./Yeast Resources/Pairwise/Spell/BioProcessOnly/BioProcessOnly_113x2000x53_Net_fold',f'113x2000x53','BioProcOnly',ontologyDataset='original',inputVector='x')
    # graph.rankGenes()
