...
def main():
    ...
    GOTest = AllGoModel(int(sys.argv[1]),'25000','Modern_bioPIXIE_Data',f'Modern',foldFile='./src/PairwiseYeastNetwork/AllGOGeneFold1.csv',ontologyDataset='original',resetNet=True,inputVector='xlpg',cuda=False)
