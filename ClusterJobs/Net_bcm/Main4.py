...
def main():
    ...
    graph = AllGoGraph(model.networkLoc[:-5],f'113x{sys.argv[2]}x118',folder,name,geneFolds=foldFile,outputVector='bcm',addTerms=[],ontologyDataset='2007',evalDataset='2023')
    # graph.feedForward(int(sys.argv[1]),calcAgn=False)
