...
def main():
    ...
    start = time.time()
    GOTest = AllGoModel(int(sys.argv[1]),'5000x1000','WCE',f'Original',foldFile='./src/PairwiseYeastNetwork/AllGOGeneFold_Orignial_1.csv',ontologyDataset='original',lossFunc='WCE',alpha=float(sys.argv[2]),resetNet=True)
