...
def main():
    ...
    GOTest = AllGoModel(0,'5000',f'Focal_Loss','Original',foldFile='./src/PairwiseYeastNetwork/AllGOGeneFold_Orignial_1.csv',ontologyDataset='original',batch=50,lossFunc='focalLoss')
    GOTest.trainNetwork(80000)
    GOTest.testNetworkAll(runAll=True)
    GOTest.testNetworkAll(runAll=True,validation=False)
