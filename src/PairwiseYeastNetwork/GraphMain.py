...
def main():
    ...
    graph = AllGoGraph('./Yeast Resources/Pairwise/Spell/AllGO_Original_Struct_ParaSearch/Original_113x2000x92_Net_fold','113x2000x92','WrongTerm',ontologyDataset='original')
    #graph.feedForward(int(sys.argv[1]),runNegatives=False,offSet=5)
    graph.rankGenes()
