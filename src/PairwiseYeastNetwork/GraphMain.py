...
def main():
    ...
    graph = AllGoGraph(f'./Yeast Resources/Pairwise/Spell/Modern_bioPIXIE_Data/Modern_149x25000x53_Net_fold',f'149x25000x53','Modern_bioPIXIE_Data',ontologyDataset='modern',inputVector='xlpg')
    # graph.rankGenes()
