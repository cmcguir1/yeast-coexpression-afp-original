...
def main():
    ...
    GOTest = AllGoModel(0,'25000',f'Test',f'Original',foldFile='./src/PairwiseYeastNetwork/AllGOGeneFold1.csv',ontologyDataset='original',resetNet=True,cuda=False,inputVector='x',lossFunc=sys.argv[1],batch=50)
    GOTest.trainNetwork(40000,track=100,parallel=True)
    GOTest.testNetworkAll(runAll=True)
    GOTest.testNetworkAll(runAll=True,validation=False)
