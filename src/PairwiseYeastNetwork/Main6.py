...
def main():
    ...
    start = time.time()
    GOTest = AllGoModel(int(sys.argv[1]),'50000x10000x5000x1000','Overfit_LargeNet',f'NoDropout',foldFile='./src/PairwiseYeastNetwork/AllGOGeneFold1.csv',ontologyDataset='original',resetNet=True,cuda=False)
