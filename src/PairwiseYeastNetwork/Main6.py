...
def main():
    ...
    start = time.time()
    GOTest = AllGoModel(int(sys.argv[1]),'5000x1000','WCE_Drop',f'Original',foldFile='./src/PairwiseYeastNetwork/AllGOGeneFold_Orignial_1.csv',ontologyDataset='original',lossFunc='WCE',alpha=0.5,resetNet=True,hiddenDropout=0.2)
