...
def main():
    ...
    GOTest = AllGoModel(int(sys.argv[1]),sys.argv[2],'BioProc+MolFunc',f'MolFunc',foldFile='./src/PairwiseYeastNetwork/AllGOGeneFold1.csv',ontologyDataset='original',resetNet=True,cuda=False,includeLocalization=True,onlyBioProc=False,includeMolecularFunc=True)
