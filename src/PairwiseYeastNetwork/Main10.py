...
def main():
    ...
    # model = AllGoModel(int(sys.argv[1]),'100','HardNegatives','EasyNegatives',ontologyDataset='2007',foldFile='src/PairwiseYeastNetwork/AllGO_2007_b_1.csv',resetNet=True)
