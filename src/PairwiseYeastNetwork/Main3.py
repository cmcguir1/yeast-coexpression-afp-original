...
def main():
    ...
    start = time.time()
    GOTest = AllGoModel(int(sys.argv[1]),'5000x1000','WCE_Control',f'Control',foldFile='./src/PairwiseYeastNetwork/AllGOGeneFold_Orignial_1.csv',ontologyDataset='original',lossFunc='CE',resetNet=True)
