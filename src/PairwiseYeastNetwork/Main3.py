...
def main():
    ...
    regularize = True
    GOTest = AllGoModel(0,sys.argv[3],sys.argv[1],sys.argv[2],ontologyDataset='modern',regularize=regularize,memMapLoc='../YeastMemMap/YeastCorrDictionary.dat')
    GOTest.trainNetwork(100000)
