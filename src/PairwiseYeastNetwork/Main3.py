...
def main():
    ...
    GOTest = AllGoModel(int(sys.argv[1]),'25000','Modern_bioPIXIE_Data_4',f'Modern',foldFile='./src/PairwiseYeastNetwork/AllGOGeneFold1.csv',ontologyDataset='modern',resetNet=True,inputVector='xlpg',cuda=False,batch=50)
