...
def main():
    ...
    GOTest = AllGoModel(int(sys.argv[1]),'2000',sys.argv[2],'Original',foldFile='./src/PairwiseYeastNetwork/AllGOGeneFold_Orignial_1.csv',ontologyDataset='original',batch=50,lossFunc=sys.argv[2],batch=200)
