...
folder = './Yeast Resources/GraphResults/SingleTerms_100/*'
...
for term, index in termDict.items():
    ...
    if not f'./Yeast Resources/GraphResults/SingleTerms_100\\{sTerm}_SingleGeneRanking.csv' in st_rankings:
        forgotten.append(term)
