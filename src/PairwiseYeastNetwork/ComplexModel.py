...
class ComplexModel(PairwiseModel):
    def __init__(self,fold,numFolds,structure,folderName,modelName,lr=0.01,momentum=0.9,batch=20,foldFile='',numTerms=0,activation='relu',inputDrop=None,hiddenDrop=None,folder='./Yeast Resources/Datasets/All Spell/all spell datasets',recur=True,sort=False):
        ...
        self.data = ExpressionDatasets(folder=folder,statsDictLoc='./Yeast Resources/Datasets/All Spell/revisedStatsDict.csv',recur=recur,sort=sort)
