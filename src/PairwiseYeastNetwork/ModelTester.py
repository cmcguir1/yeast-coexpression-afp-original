...
def test(fold,modelName,lr=0.01,batch_size=20,epoch=5000,datasets=430,structure='20x1',posGenes='./Yeast Resources/positives_00_go04-15-07.txt',negGenes='./Yeast Resources/negatives_00_go04-15-07.txt',foldFile='./Yeast Resources/Datasets/All Spell/GeneFolds1.csv',folderName='Spell/Test'):
