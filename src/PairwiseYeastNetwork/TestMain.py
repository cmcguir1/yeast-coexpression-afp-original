...
def main():
    ...
    GOTest = AllGoModel(int(sys.argv[1]),'25000','lr',f'Cyclic',foldFile='./src/PairwiseYeastNetwork/AllGOGeneFold1.csv',ontologyDataset='original',inputVector='x',cuda=False,batch=500,lr=0.01,min_lr=1e-7)
