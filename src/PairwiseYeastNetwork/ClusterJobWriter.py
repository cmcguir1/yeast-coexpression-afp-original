...
writeJobs('Heterogeneous_Baseline_20_Graph','Main2.py')
writeJobs('Heterogeneous_Reg_100_Graph','Main3.py')
writeJobs('Heterogeneous_Reg_20_Graph','Main4.py')
writeJobs('Opt_Net20_WD0.0025_Dropout0.1','Main5.py')
writeJobs('Opt_Net100_WD0.005_Dropout0.5','Main6.py')
writeJobs('Opt_Net20_WD0.005_Dropout0.5','Main7.py')
writeJobs('BCE_20','Main8.py')
writeJobs('BCE_100','Main9.py')
writeJobs('CE_100','Main10.py')
writeJobs('CE_20','Main11.py')
writeJobs('Heterogenous_BCE_Reg_20','Main12.py')
writeJobs('Heterogenous_BCE_Baseline_20','Main13.py')
