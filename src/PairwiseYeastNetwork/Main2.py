...
def main():
    ...
    regularTest = PairwiseModel(modelData,1,'20x10x1','Spell/Test','SpeedTest',lr=0.1,batch=50)
    regularTest.trainNetwork(10000,printLoss=True,lossFile='./Yeast Resources/Datasets/All Spell/SpeedTestLoss2.csv')
