...
def main():
    ...
    for i in range(4):
        ...
        GOTest = AllGoModel(i,sys.argv[1],'AllGO_Original_TrainRedo','Original',foldFile='./src/PairwiseYeastNetwork/AllGOGeneFold_Orignial_1.csv',memMapLoc='../YeastMemMap/YeastCorrDictionary.dat',ontologyDataset='original')
