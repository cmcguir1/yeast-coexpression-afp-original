...
def main():
    ...
    complexModel.trainNetwork(epochs=1,printLoss=True)
    complexModel.testNetworkValidation(limitNegative=True,negProportion=1,posProportion=100)
    complexModel.testNetworkTraining(limitNegative=True,negProportion=1,posProportion=100)
