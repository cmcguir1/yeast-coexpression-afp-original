...
def main():
    ...
    graph.rankGenes(f'Original_113x{sys.argv[2]}x1_Ranked_HalfPos.csv','./Yeast Resources/GraphResults/Original_113x20x1/Original_113x20x1_Pairs.csv')
    #graph.dividePosNeg('./Yeast Resources/GraphResults/Original_113x20x1/Original_113x20x1_Pairs.csv')
    #graph.compareGOTerms('./Yeast Resources/agnostic_01_underannotated.txt','./Yeast Resources/GeneSets/GO0006302_Pos.txt',cutoff=4000)
