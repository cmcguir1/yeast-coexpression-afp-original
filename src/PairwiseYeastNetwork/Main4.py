...
def main():
    ...
    graph = AllGoGraph('./Yeast Resources/Pairwise/Spell/AllGO_Original_Struct/Original_113x25000x92_Net_fold','113x25000x92','Large_SaveAll_Original',ontologyDataset='original')
