...
def main():
    ...
    #graph = AllGoGraph('./Yeast Resources/Pairwise/Spell/AllGO_Original_Parameter/Original_113x200x92_Net_fold','113x200x92','AllGO_Original_Redo',ontologyDataset='original',geneFolds='./src/PairwiseYeastNetwork/AllGOGeneFold_Orignial_1.csv')
