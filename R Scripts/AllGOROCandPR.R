...
wd <- getwd()
saveDir <- "C:/Users/colem/SummerResearch2022/Yeast Resources/Yeast Graphs/WCE"
#saveDir <- "D:/YeastStor/lr_decay"

dirs <- list.dirs(path = getwd(),full.names = TRUE)
dirs <- dirs[2:length(dirs)]
testDirs <- dirs[grepl("Test",dirs,fixed=TRUE)]
testDirs <- testDirs[grepl("113x5000x1000x92",testDirs,fixed=TRUE)]
